...
public class CalculateCBO2 extends TestCase {
	...
	public void testCalculatedCbo() throws IOException {
		...
		// getting all the .java file names for the set of classes
		File folder = new File(
				"C:\\Users\\Navjot\\Desktop\\SEM 2\\SOEN 6611\\PRoject\\release 3\\client");
		...
		for (String fileName : folder.list()) {
			...
			allClassName.put(i, "org.apache.hadoop.yarn.client." + fileName);
			++i;
	...
	private void calculateCBO(String classFileName, HashMap<Integer, String> allClassName)
		...
		File file = new File(
				"C:\\Users\\Navjot\\Desktop\\SEM 2\\SOEN 6611\\PRoject\\release 3\\client\\"
						+ classFileName.substring(30, classFileName.length()));
		...
		// step 2 - get methods and fields of the other classes in the package
		// and
		// calculate CBO
...
//		}
		...
		//comparing with value calculated using SourceMeter
		Assert.assertEquals(3, CBO);
